...
```
Note: Download [concat_seq_genes](https://github.com/amholtz/Africa_Project/data/concat_seq_genes.fasta)
...
3. Rooting was accomplished via [TempEst(v1.5.3)](https://doi.org/10.1093/ve/vew007) by residual-mean square function. Date file ([tempest_dates.tab](https://github.com/amholtz/Africa_Project/data/tempest_dates.tab)) is adapted to [Tempest format](https://beast.community/tempest_tutorial)  from our [metadata file](https://github.com/amholtz/Africa_Project/data/metadata_edited.tab)
  ...
  **Output**: [bats_removed_pruned_TempestRooted.tree](https://github.com/amholtz/Africa_Project/data/bats_removed_pruned_TempestRooted.tree)
...
4. Sequences were subsampled by removing similar sequences within the same cluster using custom script by Sam Hong at KU Leuven [downsample_monophyl_cluster.R](https://github.com/amholtz/Africa_Project/blob/main/data/subsampling_SamScript/downsample_monophyl_cluster.R)
  ...
  **Input**: [bats_removed_pruned_TempestRooted.tree](https://github.com/amholtz/Africa_Project/data/bats_removed_pruned_TempestRooted.tree)

  **Output**: [subsampled_tree.tre](https://github.com/amholtz/Africa_Project/blob/main/data/subsampling_SamScript/subsampled_tree.tre), [keep.csv](https://github.com/amholtz/Africa_Project/blob/main/data/subsampling_SamScript/keep.csv)
...
([tempest_dates.tab](https://github.com/amholtz/Africa_Project/data/tempest_dates.tab)) imported for dates.
