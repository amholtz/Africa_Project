...
if '__main__' == __name__:
    ...
    parser.add_argument('--output_ids', type=str, nargs='+', default=['subsampled_4000.txt', 'subsampled_4000_2.txt'])
    parser.add_argument('--output_trees', type=str, nargs='+', default=['subsampled_4000.nwk', 'subsampled_4000_2.nwk'])
    parser.add_argument('--output_stats', required=False, type=str, default='subsampled_4000_stats_table.txt')
    ...
    with open('/Users/aholtz/Dropbox/rabies/Africa_Project/data/accession_seq.txt', "w") as file:
        for leaf in tree:
    ...
    min_max_dates = pd.read_csv('/Users/aholtz/Dropbox/rabies/Africa_Project/data/unique_accession_numbers.txt', index_col=0, sep='\t')
